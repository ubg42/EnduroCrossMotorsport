                ...
                return t.toString = function () {
                    ...
                    t.i = function (e, n, o, r, i) {
                        ...
                        for (var d = 0; d < e.length; d++) {
                            var l = [].concat(e[d]);
                            o && a[l[0]] || (void 0 !== i && (void 0 === l[5] || (l[1] = "@layer".concat(l[5].length > 0 ? " ".concat(l[5]) : "", " {").concat(l[1], "}")),
                                l[5] = i),
        ...
        (() => {
            ...
            function f(e) {
                ...
                var t = function (e) {
                    ...
                    if (t.length <= 2)
                        return e;
                    var n = new Set(["co.uk", "gov.uk", "ac.uk", "sch.uk", "com.au", "net.au", "org.au", "com.br", "com.mx", "com.tr", "com.ar", "com.cn", "com.hk", "com.tw", "com.sg", "com.my", "com.id", "co.nz", "co.in", "co.kr", "co.za", "co.jp"])
                        , o = t.slice(-2).join(".")
                        , r = t.slice(-3).join(".");
            ...
            var g = new Set(["authorize.roblox.com", "accounts.google.com", "appleid.apple.com", "idmsa.apple.com", "login.microsoftonline.com", "login.live.com"])
                ...
                , y = new Set(["doubleclick", "googlesyndication", "googleapis", "googleadservices", "adsenseformobileapps"])
            ...
            function v() {
                var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = t.search, o = void 0 === n ? "" : n, r = t.referrer, i = void 0 === r ? "" : r, a = new URLSearchParams(o), s = p(i), c = f(s), d = "" !== i, l = a.has("tt"), u = a.has("sc"), v = m(a, "utm_source"), b = m(a, "utm_medium"), k = m(a, "utm_term"), A = m(a, "poki_source"), S = m(a, "placement"), E = m(a, "gclid"), I = m(a, "msclkid"), _ = m(a, "yclid"), x = m(a, "ttclid"), P = m(a, "fbclid"), T = m(a, "adgroup"), C = m(a, "creative"), O = m(a, "network");
                e = c || ("" === s && "" !== i ? "" : i);
                var D, L, M = !d || "poki" === e || y.has(e), B = (D = (i || "").match(/^android-app:\/\/([^/]+)/i)) ? D[1].toLowerCase() : null, N = function (e) {
                    var t = (e || "").match(/^ios-app:\/\/([^/]+)/i);
                    return t ? t[1].toLowerCase() : null
                }(i), R = function (e) {
                    var t = (e || "").match(/^mobileapp::\d+-([^/]+)/i);
                    return t ? t[1].toLowerCase() : null
                }(i), j = M && S.includes("mobileapp::") && S.includes("mobileapp::2-") ? function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : /^mobileapp::2-([^/]+)/
                        , n = (e || "").match(t);
                    return n ? n[1] : null
                }(S) : null;
                L = "chrome_extension" === v ? "poki_chrome_extension" : "edge_extension" === v ? "poki_edge_extension" : l ? "tiktok" : u ? "snapchat" : "android_app" === A ? "poki_android_app" : "web_app_manifest" === v ? "pwa" : B || (N || (R || (!d && v ? v : j || (M && S ? f(p(S)) || S : "g" === O ? "google" : "ytv" === O ? "youtube" : d || E || I || _ || x || P || T || C ? !d && E && /^\d+$/.test(E) ? "direct" : "" === e && d ? "unknown" : e || "unknown" : "direct"))));
                var F, U = h.has(L) || !!(E || I || _ || x || P || T || C) || "cpc" === b || "rtb-cpm" === b || "ppc" === b || "paid" === b, V = (s || "").toLowerCase(), G = !g.has(V) && (w.has(L) || /^com\.google\.android\.googlequicksearchbox$/.test(V) || function (e) {
                    return /^webcache\.googleusercontent\.com$/.test(e)
                }(V) || !!k && "share" !== b);
                return F = "snapchat" === v ? "cpc" : P && !v ? "organic" : U ? "cpc" : G ? "organic" : g.has(V) ? "oauth" : "pwa" === L || "poki_android_app" === L || d || "social" === b || "email" === b ? "referral" : L ? "unknown" : "direct",
                    "direct" === L && "direct" !== F && "unknown" !== F && "referral" !== F && (L = "unknown"),
                    h.has(L) && (L = "unknown"),
                    "poki" === L && "cpc" === F && (L = "unknown"),
                {
                    source: L,
                    medium: F
                }
            ...
            function I() {
                var e = null;
                E(window[window._pokiSessionGlobalName], !1) && (e = window[window._pokiSessionGlobalName]);
                try {
                    var t = sessionStorage.getItem(k);
                    if (t) {
                        var n = JSON.parse(t);
                        E(n, !1) && (!e || n.depth > e.depth) && (e = n)
                    }
                } catch (e) {
                    try {
                        a(e, "getSession", sessionStorage.getItem(k))
                    } catch (t) {
                        a(e, "getSession", t)
                    }
                }
            ...
            function _() {
                ...
                try {
                    ...
                    try {
                        a(e, "getPreviousSessionCount", sessionStorage.getItem(k))
                    } catch (t) {
                ...
                try {
                    ...
                    try {
                        a(e, "getPreviousSessionCount", o(k))
                    } catch (t) {
                        a(e, "getPreviousSessionCount", t)
                    }
                }
            ...
            function P() {
                ...
                try {
                    ...
                    if (n) {
                        var r = JSON.parse(n);
                        !E(r, !t) || t && r.id !== t.id || (e = Math.max(e, r.depth))
                    }
                } catch (e) {
                    var i = null;
                    try {
            ...
            const T = (e, t) => {
                ...
                , C = ["AT", "BE", "BG", "HR", "CY", "CZ", "DK", "EE", "FI", "FR", "DE", "GR", "GB", "HU", "IE", "IT", "LV", "LT", "LU", "MT", "NL", "PL", "PT", "RO", "SK", "SI", "ES", "SE", "IS", "LI", "NO"];
            const O = (e, t) => {
                ...
                , D = () => "undefined" != typeof navigator && /(?:phone|windows\s+phone|ipod|blackberry|(?:android|bb\d+|meego|silk|googlebot) .+? mobile|palm|windows\s+ce|opera mini|avantgo|mobilesafari|docomo|kaios)/i.test(navigator.userAgent)
            ...
            const B = O("referrer") || ""
                ...
                , R = {
                    ...
                    device: D() ? "mobile" : L() ? "tablet" : "desktop",
                    ...
                    gameID: O("game_id"),
                    gdprApplies: (j = (O("country") || "").toUpperCase(),
                        C.includes(j)),
            ...
            class V {
                static sendMessage(t, n, o = window.parent) {
                    ...
                    const r = n || {};
                    U.gameID && U.versionID && (r.pokifordevs = {
                        game_id: U.gameID,
                        game_version_id: U.versionID
                    }),
                        o?.postMessage({
                            type: t,
                            content: r
            ...
            class G {
                ...
                static init = (e, t) => {
                    const { hostname: n } = window.location
                        , o = "localhost" === n || "127.0.0.1" === n || "[::1]" === n || "launch.playcanvas.com" === n || "https://gemini.google.com" === document.location.ancestorOrigins?.[0];
                    void 0 === e && (o ? (e = !0,
                        void 0 === t && (t = !1)) : (e = !1,
                            void 0 === t && (t = !1))),
                        U.isInspector ? (e = !0,
                            t = !0) : (n.endsWith(".poki-gdn.com") || n.endsWith(".gdn.poki.com")) && (e = !1,
                                t = !1),
                        U.debugMode && (e = !0),
                        U.logMode && (t = !0),
                        void 0 === t && (t = e),
            ...
            class H {
                ...
                static addEventListener(e, t, n = !1) {
                    if (n = !!n,
                        ...
                        n) {
                        const n = o => {
                            this.removeEventListener.bind(this)(e, n),
                                t(o)
                        }
                            ;
            ...
            const J = (e, t = !1) => new Promise((n, o) => {
                const r = document.createElement("script");
                r.type = t ? "module" : "text/javascript",
                    r.async = !0,
                    r.src = e;
                const i = () => {
                    r.readyState && "loaded" !== r.readyState && "complete" !== r.readyState || (n(),
                        r.onload = null,
            ...
            class X {
                ...
                static track(t, n = {}) {
                    try {
                        ...
                        const r = H.getVideoDataAnnotations();
                        if (r?.pokiAdServer)
                            switch (t) {
                                case e.tracking.ads.status.started:
                                    {
                                        const { creativeId: e } = r;
                                        H.addVideoDataAnnotations({
                                            houseAdId: e
                                        }),
                                            o.houseAdId = e;
                                        break
                        ...
                        if (t.includes("pokiTrackingRewardedWeb") && (o = r),
                            G.log && (Object.keys(o).length ? console.info(`%cPOKI_TRACKER:%c Tracked event '${t}' with data:`, "font-weight: bold", "", o) : console.info(`%cPOKI_TRACKER:%c Tracked event '${t}'`, "font-weight: bold", "")),
                            Q?.({
                                event: t,
                                data: o
                            }),
                            V.sendMessage(e.message.event, {
                                event: t,
                                data: o
                            }),
                            !(U.isPokiIframe || U.isInspector || U.isPlayground || U.isPokiExternal)) {
                            const n = "sdk"
                                , r = "message"
                                , i = {
                                    content: {
                            ...
                            X.logToObserver ? X.pushEvent(n, r, i) : (X.eventQueue.push([n, r, i]),
                                X.eventQueue.length > 100 && X.eventQueue.shift())
                        }
                    } catch (e) {
                ...
                static setupObserverIfCMP() {
                    if (void 0 !== X.cmpRequired && void 0 !== X.cmpIndex)
                        if (X.cmpRequired) {
                            if (!window.__tcfapi)
                            ...
                            window.__tcfapi("addEventListener", 2, (e, t) => {
                                !t || "tcloaded" !== e.eventStatus && "useractioncomplete" !== e.eventStatus || (window.__tcfapi("getNonIABVendorConsents", 2, e => {
                                    e && e.nonIabVendorConsents && e.nonIabVendorConsents[X.cmpIndex || 0] && X.setupObserver()
                                }
                                ),
                ...
                static setupObserver() {
                    for (Z._pokiSessionGlobalName = "pokiSession",
                        Z._pokiUserGlobalName = "pokiUser",
                        Z._pokiContextGlobalName = "pokiContext",
                        Z._pokiTrackerGlobalName = "pokiTracker",
                        function (e, t, n) {
                            var s, d = null;
                            try {
                                (d = I()) ? (d.previous_page.path = d.page.path,
                                    ...
                                    d.page.pageview_id = i(),
                                    d.depth = P() + 1,
                                    d.expire = Date.now() + b) : d = function (e, t, n) {
                                        try {
                                            var s = o(k);
                                            if (s) {
                                                var c = JSON.parse(s);
                                                if (E(c, !0))
                                                    return c.previous_page.path = c.page.path,
                                                        ...
                                                        c.page.pageview_id = i(),
                                                        c.depth = P() + 1,
                                                        c.expire = Date.now() + b,
                                                        c.tab_id = x(),
                                                        r(k, JSON.stringify(c)),
                                                        c
                                            }
                                        } catch (e) {
                                            var d = null;
                        ...
                        }(window.location.pathname, "external", U.contentGameID),
                        function () {
                            var e, t, n, a, p = null === (e = window[window._pokiUserGlobalName]) || void 0 === e ? void 0 : e.id, f = (null === (t = window[window._pokiUserGlobalName]) || void 0 === t ? void 0 : t.is_new) || !1, m = (null === (n = window[window._pokiUserGlobalName]) || void 0 === n ? void 0 : n.version) || 0, g = (null === (a = window[window._pokiUserGlobalName]) || void 0 === a ? void 0 : a.ttl) || u;
                            p || (p = o(s),
                                f = "1" === o(c),
                                m = parseInt(o(d), 10) || 0,
                                g = parseInt(o(l), 10) || g),
                        ...
                        Z[Z._pokiSessionGlobalName].referrer = U.referrerParam,
                        ...
                        Z.pokiGTM = Z.pokiGTM || [],
                        J("https://a.poki-cdn.com/t2.js"),
                        X.logToObserver = !0; X.eventQueue.length;) {
                        const [e, t, n] = X.eventQueue.shift();
                        X.pushEvent(e, t, n)
                    }
                }
            }
            ...
            const ie = []
                ...
                , se = console.error
                , ce = ["Audio callback had starved sending audio by"];
            let de = !1;
            const le = Math.random().toString(36).substring(2);
            let ue;
            function pe() {
                const e = window;
            ...
            function fe(e, t = !0) {
                U.gameID && !U.isPlayground ? ae(t => {
                    try {
                        const n = e.message || ne(e);
                        ie.push({
                            n: e.name,
                            m: n,
                        ...
                        se("%cPOKI:%c failed to log error", "font-weight: bold", "", e)
                    }
                }
                ) : t && console.error("%cPOKI:%c game error", "font-weight: bold", "", e)
            }
            function me(e) {
                te(e.reason) ? fe(e.reason) : fe({
                    name: "unhandledrejection",
                    message: JSON.stringify(e.reason) || ne(e)
                })
            }
            function ge(e) {
                te(e.error) ? fe(e.error) : fe(e)
            }
            function he() {
                if (U.gameID && !U.isPlayground && !U.isPokiExternal && U.isPokiIframe && !de) {
                    de = !0,
                        window.addEventListener("unhandledrejection", me),
                        window.addEventListener("error", ge);
                    try {
                        console.error = (...e) => {
                            const t = ne(e);
                            ce.some(e => t.includes(e)) || fe({
                                name: "console.error",
                                message: t
                            }, !1),
                                se.apply(console, e)
            ...
            const ve = window.requestAnimationFrame;
            function be(e) {
            ...
            class ke {
                ...
                #n;
                constructor(e) {
                    Math.random() > e || (this.#n = performance.now() + 1e3,
                        ve(() => {
                            this.#o()
                        }
                        ))
                ...
                #o() {
                    ...
                    for (; e >= this.#n;)
                        this.#e.unshift(this.#t),
                            this.#e.length > 10 && this.#e.pop(),
                            this.#t = 0,
                            this.#n += 1e3;
                    this.#t++,
                        ve(() => {
                ...
                stats() {
                    ...
                    const e = Math.min(...this.#e)
                        , t = Math.max(...this.#e)
                        , n = be(this.#e.reduce((e, t) => e + t, 0) / this.#e.length);
                    let o = be(this.#e.slice(1).map((e, t) => Math.abs(e - this.#e[t])).reduce((e, t) => e + t, 0) / (this.#e.length - 1));
            ...
            class Ee {
                ...
                static trackSavegames() {
                    window.cookieStore && window.cookieStore.getAll && U.gameID && (Math.random() > .01 || navigator.userAgent.indexOf("Safari") > -1 && navigator.userAgent.indexOf("Chrome") <= -1 || (Ee.collectAndLog(),
                        setInterval(Ee.collectAndLog, 12e4)))
                }
            }
            const Ie = (() => {
                let e = 0;
            ...
            function Oe(e, t = {}) {
                ...
                if (o)
                    return o;
                const r = t.includeStyleProperties ?? _e(window.getComputedStyle(document.documentElement))
            ...
            function Le(e, t = {}) {
                return {
                    width: t.width || function (e) {
                        const t = De(e, "border-left-width")
                            , n = De(e, "border-right-width");
                        return e.clientWidth + t + n
                    }(e),
                    height: t.height || function (e) {
                        const t = De(e, "border-top-width")
                            , n = De(e, "border-bottom-width");
            ...
            function je(e, t, n, o) {
                ...
                s.appendChild(Re(a, n, r, o)),
                    t.appendChild(s)
            }
            const Fe = "application/font-woff"
                , Ue = "image/jpeg"
                , Ve = {
                    woff: Fe,
                    woff2: Fe,
            ...
            async function We(e, t, n) {
                ...
                try {
                    const o = await He(e, n.fetchRequestInit, ({ res: e, result: n }) => (t || (t = e.headers.get("Content-Type") || ""),
                        function (e) {
                            return e.split(/,/)[1]
                        }(n)));
                    r = Ke(o, t)
                    ...
                    t && (o = "string" == typeof t ? t : t.message),
                        o && console.warn("%cPOKI:%c failed to fetch resource", "font-weight: bold", "", o)
                }
                return qe[o] = r,
                    r
            }
            async function Ye(e, t) {
                        ...
                        try {
                            requestAnimationFrame(() => {
                                ...
                                r.bindTexture(r.TEXTURE_2D, i),
                                    ...
                                    r.readPixels(0, 0, e.width, e.height, r.RGBA, r.UNSIGNED_BYTE, new Uint8Array(n.data.buffer)),
                                    t.putImageData(n, 0, 0),
                                    r.deleteTexture(i),
                                    r.deleteFramebuffer(a);
                                const s = r.getExtension("WEBGL_lose_context");
                                s && s.loseContext(),
                                    o(t.canvas.toDataURL())
                            }
                            )
                        } catch {
                            o("data:,")
                ...
                }(e, t) : e.cloneNode(Qe(e))
            }
            const Je = e => "SLOT" === e.tagName?.toUpperCase()
                , Qe = e => null != e.tagName && "SVG" === e.tagName.toUpperCase();
            function $e(e, t, n) {
                return function (e, t, n) {
                    ...
                    r.cssText ? (o.cssText = r.cssText,
                        o.transformOrigin = r.transformOrigin) : Oe(e, n).forEach(n => {
                            let i = r.getPropertyValue(n);
                            if ("font-size" === n && i.endsWith("px")) {
                                const e = Math.floor(parseFloat(i.substring(0, i.length - 2))) - .1;
                                i = `${e}px`
                            }
                            Pe(e, HTMLIFrameElement) && "display" === n && "inline" === i && (i = "block"),
                                "d" === n && t.getAttribute("d") && (i = `path(${t.getAttribute("d")})`),
                                o.setProperty(n, i, r.getPropertyPriority(n))
                        }
                        )
                }(e, t, n),
                    Pe(e, HTMLElement) && Pe(t, HTMLElement) && (function (e, t) {
                        Pe(e, HTMLTextAreaElement) && (t.innerHTML = e.value),
                            Pe(e, HTMLInputElement) && t.setAttribute("value", e.value)
                    }(e, t),
                        function (e, t) {
            ...
            async function Xe(e, t, n) {
                return n || !t.filter || t.filter(e) ? xe(e) ? (Ze++,
                    Ze % 5 == 0 && await (o = 0,
                        e => new Promise(t => {
                            setTimeout(() => t(e), o)
                        }
                    ...
                    Promise.resolve(e).then(e => Ye(e, t)).then(n => async function (e, t, n) {
                        if (Qe(t))
                            return t;
                        let o = [];
                        return o = Je(e) && e.assignedNodes ? _e(e.assignedNodes()) : Pe(e, HTMLIFrameElement) && e.contentDocument?.body ? _e(e.contentDocument.body.childNodes) : _e(("shadowRoot" in e ? e.shadowRoot ?? e : e).childNodes),
                            0 === o.length || Pe(e, HTMLVideoElement) || await o.reduce((e, o) => e.then(() => Xe(o, n)).then(e => {
                                e && t.appendChild(e)
                            }
                            ), Promise.resolve()),
                            t
            ...
            const et = /url\((['"]?)([^'"]+?)\1\)/g
                , tt = /url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g
                , nt = /src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;
            async function ot(e, t, n, o, r) {
                try {
            ...
            async function it(e, t, n) {
                ...
                const o = function (e, { preferredFontFormat: t }) {
                    ...
                    , r = function (e) {
                        const t = [];
                        return e.replace(et, (e, n, o) => (t.push(o),
                            e)),
                            t.filter(e => !ze(e))
                    }(o);
                return r.reduce((e, o) => e.then(e => ot(e, o, t, n)), Promise.resolve(o))
            }
            async function at(e, t, n) {
                const o = t.style?.getPropertyValue(e);
                if (o) {
                    const r = await it(o, null, n);
                    return t.style.setProperty(e, r, t.style.getPropertyPriority(e)),
                        !0
                }
                return !1
            }
            async function st(e, t) {
                xe(e) && (await async function (e, t) {
                    await at("background", e, t) || await at("background-image", e, t),
                        await at("mask", e, t) || await at("mask-image", e, t)
                }(e, t),
                    await async function (e, t) {
                        const n = Pe(e, HTMLImageElement)
                            , o = Pe(e, SVGImageElement);
                        if ((!n || ze(e.src)) && (!o || ze(e.href.baseVal)))
                            return;
                    ...
                    await async function (e, t) {
                        const n = _e(e.childNodes).map(e => st(e, t));
                ...
                const o = /url\(["']?([^"')]+)["']?\)/g
                    , r = (n.match(/url\([^)]+\)/g) || []).map(async r => {
                        ...
                        return i.startsWith("https://") || (i = new URL(i, e.url).href),
                            He(i, t.fetchRequestInit, ({ result: e }) => (n = n.replace(r, `url(${e})`),
                                [r, e]))
                    }
                    );
            ...
            async function pt(e, t) {
                ...
                const n = _e(e.ownerDocument.styleSheets)
                    , o = await async function (e, t) {
                        ...
                        return e.forEach(n => {
                            if ("cssRules" in n)
                                try {
                                    _e(n.cssRules || []).forEach((e, r) => {
                                        if (e instanceof CSSImportRule) {
                                            let i = r + 1;
                                            const a = dt(e.href).then(e => lt(e, t)).then(e => ut(e).forEach(e => {
                                                try {
                                    ...
                                    null != n.href && o.push(dt(n.href).then(e => lt(e, t)).then(e => ut(e).forEach(e => {
            ...
            async function gt(e, t = {}) {
                ...
                return a.width = d * c,
                    ...
                    t.skipAutoScale || function (e) {
                        (e.width > Me || e.height > Me) && (e.width > Me && e.height > Me ? e.width > e.height ? (e.height *= Me / e.width,
                            e.width = Me) : (e.width *= Me / e.height,
                                e.height = Me) : e.width > Me ? (e.height *= Me / e.width,
                                    e.width = Me) : (e.width *= Me / e.height,
                                        e.height = Me))
                    }(a),
                    a.style.width = `${d}`,
            ...
            async function vt(e, t = {}, n = 5e3) {
                ...
                const s = new Promise((e, t) => {
                    a = setTimeout(() => {
                        o.abort(),
                            t(new DOMException(`Signal timed out after ${n}ms`, "AbortError"))
                    }
                        , n)
                }
                );
                try {
                    ...
                    throw a && clearTimeout(a),
                    t instanceof Error && "AbortError" === t.name ? (W(`fetchWithTimeout: Fetch aborted for ${e}. Error: ${t.message}`),
                        t) : t instanceof Error ? (W(`fetchWithTimeout: Fetch error for ${e}:`, t.message),
                            t) : (W(`fetchWithTimeout: An unexpected error occurred for ${e}:`, t),
                                new Error("An unexpected fetch error occurred."))
                }
            }
            const bt = async e => {
                const { screenshot: t } = e
                    , n = await vt("https://api.poki.io/screenshot", {
                        method: "POST",
                        headers: {
                ...
                , kt = async () => {
                    const e = e => !["VIDEO", "TEXTAREA", "SCRIPT", "NOSCRIPT", "INPUT", "IFRAME"].includes(e.nodeName) && (!("IMG" === e.nodeName && !e.getAttribute("src")) && !e.classList?.contains(wt().container))
                        , t = document.body.style.minWidth
                        , n = document.body.style.minHeight;
                    document.body.style.minWidth = "100%",
                        document.body.style.minHeight = "100%";
                    let o = await ht(document.body, {
                        filter: e,
                    ...
                    if (t && t.length > 10) {
                        e && (t = await (async (e, t) => {
                            ...
                            const l = new FontFace("TorusBold", "url(https://a.poki-cdn.com/fonts/torus-bold-latin.woff2)").load()
                                , [u, p, f, m] = await Promise.all([i, s, d, l])
                            ...
                            )(h, f, 64 * y, v + 20 * y, b, b, 24 * y);
                            const { fonts: k } = document;
                            k.add(m);
                            const A = 226 * y
                                , S = v + 68 * y;
                            return h.textAlign = "left",
                                h.textBaseline = "top",
                                h.fillStyle = "#002b50",
                                h.font = `700 ${56 * y}px TorusBold,sans-serif`,
                                h.fillText(n, A, S),
                                g.toDataURL()
                        }
                        )(t, e));
            ...
            function Lt(e) {
                if ("" !== e && e !== Et && e !== It && e !== _t && e !== xt)
                    throw new Error(`Invalid playtest capture mode: ${e}`);
                Tt = e
            }
            const Mt = "MacIntel" === window.navigator.platform && void 0 !== window.navigator.standalone && navigator.maxTouchPoints > 1
            ...
            class Ft {
                ...
                update(e) {
                    var t, n, o;
                    e && !this.previousMouseDown && (this.drawSize += this.#r,
                        this.drawSize = (t = this.drawSize,
                            n = this.#i,
                            o = this.#a,
                            Math.min(Math.max(t, n), o))),
                        this.drawSize -= this.#c,
                        this.drawSize = e ? Math.max(this.drawSize, this.#s) : Math.max(this.drawSize, 0),
            ...
            function Gt(e, t, n, o, r, i) {
                ...
                if (function (e, t, n, o, r, i) {
                    ...
                    !Nt) {
                    const t = .5 * a;
                    i.drawImage(jt, 0, 0, jt.width, jt.height, e.x * o, e.y * r, jt.width * t, jt.height * t)
                }
            }
            const zt = "Game tab in background";
            let Kt = !0
                , Ht = []
                , qt = null
            ...
            (D() || L() || Mt) && (nn = 12),
                ...
                Wt.addEventListener("webglcontextlost", () => {
            ...
            let rn = !1
                ...
                , fn = -1;
            function mn(e) {
                if (null === qt || !Ht.length)
                    return;
                const t = Ht[0]
                    , n = t.width / qt.width
                    , o = t.height / qt.height
                    , r = (e.clientX - qt.left) * n
                    , i = (e.clientY - qt.top) * o;
                on.x = Math.max(0, Math.min(r, t.width)),
            ...
            const gn = e => {
                ...
                , hn = e => {
                    Ht.length && Wt && (0 === e.button ? (rn = !0,
                        an = !1) : 2 === e.button ? (sn = !0,
                            cn = !1) : 1 === e.button && (rn = !0,
                                an = !1,
                                sn = !0,
                                cn = !1),
                        mn(e))
                ...
                , yn = e => {
                    0 === e.button ? an = !0 : 2 === e.button ? cn = !0 : 1 === e.button && (an = !0,
                        cn = !0)
                }
                ;
            function wn() {
                const e = dn;
                e && Wt && Yt && (Yt.fillStyle = "rgba(255, 255, 255, 0.5)",
                    Yt.fillRect(0, 0, Wt.width, Wt.height),
                    Yt.font = "48px Arial",
                    Yt.fillStyle = "#009cff",
                    Yt.textAlign = "center",
                    Yt.fillText(e, Wt.width / 2, Wt.height / 2))
            }
            function vn(e) {
                if (!Wt || !Ht.length)
                    return;
                ...
                pn = n,
                    fn = o,
                    qt = t.getBoundingClientRect();
                let { width: r, height: i } = qt;
                0 !== r && 0 !== i || (r = n,
                    i = o);
                const a = D() || L()
                    , s = Mt ? 1024 : a ? 640 : 1280
                    , c = Math.min(s / r, s / i, 1);
                r = Math.round(r * c),
                    i = Math.round(i * c),
                    ln = r / n,
                    un = i / o;
                e || Wt.width !== r || Wt.height !== i ? (Wt.width = r,
                    Wt.height = i,
                    console.info(`%cPOKI_PLAYTEST:%c capturing at ${r}x${i} (${n}x${o})`, "font-weight: bold", "")) : console.info(`%cPOKI_PLAYTEST:%c resize but video unchanged ${r}x${i} (${n}x${o})`, "font-weight: bold", "")
            }
            function bn(e) {
                let t = null;
                for (let n = 0; n < e.length; n++)
                    if (!document.body.contains(e[n])) {
                        if (e[n].pokiHtmlDummyCanvas)
                            continue;
                        if (t || (t = document.getElementsByTagName("flt-glass-pane")),
                            t) {
                            let o = !1;
                            for (let r = 0; r < t.length; r++)
                                t[r].shadowRoot?.contains(e[n]) && (o = !0);
                            if (o)
                                continue
                        }
                        return !1
            ...
            async function kn(e) {
                if (Wt && (Jt || (Jt = document.createElement("canvas"),
                    0 === Ht.length ? (Jt.width = Wt.width,
                        Jt.height = Wt.height) : (Jt.width = Ht[0].width,
                            Jt.height = Ht[0].height),
                    Jt.addEventListener("contextlost", () => {
                        Jt = null,
                            Qt = null
                    }
                    )),
                    Qt || (Qt = Jt.getContext("2d"),
                        Qt)))
                    try {
                        performance.now();
                        const t = await (async e => {
                            ...
                            e || t.push("CANVAS");
                            const n = e => !(t.includes(e.nodeName) || "IMG" === e.nodeName && !e.getAttribute("src") || e.classList?.contains(wt().container) || "true" === e.getAttribute?.("data-poki-playtest-skip"))
                            ...
                            return document.body.style.minWidth = o,
                        ...
                        if (t && t.length > 10) {
                            ...
                            requestAnimationFrame(() => {
                                Jt && Qt && (Qt.clearRect(0, 0, Jt.width, Jt.height),
                                    Qt.drawImage(e, 0, 0, e.width, e.height, 0, 0, Jt.width, Jt.height),
                                    $t = 0)
                            }
                            )
                        }
                    ...
                    try {
                        if (Bt)
                            for (let e = 0; e < Ht.length; e++) {
                                if (Ht[e].pokiHtmlDummyCanvas)
                                    continue;
                                const t = Ht[e].captureStream(nn).getVideoTracks()[0];
                                Zt.push(t),
                                    tn.push(null);
                            ...
                            for (let e = 0; e < Ht.length; e++) {
                                ...
                                Zt.push(t),
                                    ...
                                    tn.push(null);
                                const r = () => {
                                    o.read().then(({ done: t, value: n }) => {
                                        t ? Kt = !0 : tn.length <= e ? n.close() : (null !== tn[e] && tn[e].close(),
                                            tn[e] = n,
                                            r())
                                    }
                                    )
            ...
            function In(e, t) {
                ...
                window.addEventListener("pointermove", gn, {
                    ...
                    window.addEventListener("pointerup", yn, {
                        capture: !0,
                        passive: !0
                    }),
                    window.addEventListener("contextmenu", yn, {
                        capture: !0,
                        passive: !0
                    });
                let r, i = 0, a = null;
                ...
                if (s === _t || s === It) {
                    ...
                    o = setInterval(() => {
                        if (!Wt)
                            return;
                        const t = !!Ht[0].pokiHtmlDummyCanvas;
                        !t || Ht[0].width === window.innerWidth && Ht[0].height === window.innerHeight || (Ht[0].width = window.innerWidth,
                            Ht[0].height = window.innerHeight);
                        let n = !1;
                        if (t && document.getElementsByTagName("canvas").length > 0 && (n = !0),
                            !n) {
                            const t = function (e) {
                                const t = 3 & e.length
                                    , n = e.length - t
                                ...
                                for (; s < n;)
                                    a = 255 & e.charCodeAt(s) | (255 & e.charCodeAt(++s)) << 8 | (255 & e.charCodeAt(++s)) << 16 | (255 & e.charCodeAt(++s)) << 24,
                                        ++s,
                                        a = (65535 & a) * o + (((a >>> 16) * o & 65535) << 16) & 4294967295,
                                        a = a << 15 | a >>> 17,
                                        a = (65535 & a) * r + (((a >>> 16) * r & 65535) << 16) & 4294967295,
                                        i ^= a,
                                        i = i << 13 | i >>> 19,
                                        i = 5 * i + 3864292196 & 4294967295;
                                switch (a = 0,
                                t) {
                                    case 3:
                ...
                return r = setInterval(() => {
                    if (Kt || !Wt || !Ht.length || i > 10)
                        return console.info("%cPOKI_PLAYTEST:%c", "font-weight: bold", "", Kt ? "stopped" : "crashed", Kt, !Wt, !Ht.length, i),
                            window.removeEventListener("pointermove", gn),
                            window.removeEventListener("pointerdown", hn),
                            window.removeEventListener("pointerup", yn),
                            window.removeEventListener("contextmenu", yn),
                            clearInterval(o),
                            Lt(""),
                            Wt = null,
                            Yt = null,
                    ...
                    if (!bn(Ht)) {
                        ...
                        const e = En();
                        return void (e.length ? Sn(e) : (console.info("%cPOKI_PLAYTEST:%c no source canvasses found", "font-weight: bold", ""),
                            i++))
                    }
                    if (!Yt && (Yt = Wt.getContext("2d"),
                        !Yt))
                    ...
                    for (let e = 0; e < tn.length; e++) {
                        const t = tn[e];
                        null !== t && Yt.drawImage(t, 0, 0, t.displayWidth, t.displayHeight, 0, 0, Wt.width, Wt.height)
                    }
                    Jt && Yt.drawImage(Jt, 0, 0, Jt.width, Jt.height, 0, 0, Wt.width, Wt.height),
                        Gt(on, rn, sn, ln, un, Yt),
                        rn && an && (rn = !1,
                            an = !1),
                        sn && cn && (sn = !1,
                            cn = !1),
                    ...
                    window.addEventListener("visibilitychange", () => {
                        console.info("%cPOKI_PLAYTEST:%c visibility change", "font-weight: bold", "", document.visibilityState),
                            a && clearTimeout(a),
                            "visible" === document.visibilityState ? dn === zt && (dn = "") : (dn = zt,
                                wn(),
                                a = setTimeout(() => {
                                    Kt = !0
                                }
            ...
            const _n = new RegExp(`(${["WebView", "(iPhone|iPod|iPad)(?!.*Safari)", "Android.*(;\\s+wv|Version/\\d.\\d\\s+Chrome/\\d+(\\.0){3})", "Linux; U; Android"].join("|")})`, "ig");
            function xn() {
                window.navigator.userAgent.match(_n) && !U.isPlayground && document.addEventListener("touchmove", e => (e.preventDefault(),
                    e.returnValue = !1,
                    !1), {
                    passive: !1
                })
            ...
            class Tn {
                ...
                getUser = async () => G.debug ? {
                    ...
                    this.#d || (this.#d = await this.#u()),
                    this.#d);
                getToken = async () => G.debug ? "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOiJsVVNGaCtFUjZIaW83VHhjRW9Pc0d1UnJaNU0wNFdQSlpkQ1BBZ09Wcko4Zm5QQTRmK3Zob1E4PSIsImlzcyI6IlBva2kiLCJleHAiOjIzOTIyNzU0NDd9.S7aW6C3Uwe1hINZA1kg20QWTwE0TqKhUkpJUtU16twM" : (this.#l(),
                    this.#p());
                login = async () => {
                    if (G.debug)
                        return;
                        ...
                        return new Promise(t => {
                            ...
                            const n = o => {
                                if (o.data.type === e.accounts.userInfo) {
                                    ...
                                    const { enabled: e, session: r } = o.data;
                                    if (!e || !r?.id)
                                        return void t(null);
                                    this.#d = {
                                        username: r?.username ?? Pn(),
                                        avatarUrl: r?.avatar?.medium ?? "https://a.poki-cdn.com/img/placeholder_gradient.png",
                                        optedIn: r?.optedin ?? !1
                                    },
                                        t(this.#d)
                                }
                ...
                #p = async () => {
                    try {
                        return new Promise(t => {
                            ...
                            const n = o => {
                                if (o.data.type === e.accounts.userToken) {
                                    window.removeEventListener("message", n);
                                    const { token: e, error: r } = o.data;
                                    if (r)
                                        return W("failed to fetch user token:", r),
                                            void t(null);
                                    if (!e)
                                        return void t(null);
                                    t(e)
                        ...
                        W("failed to fetch user token:", e)
                    }
                    return null
                }
            }
            ...
            function Ln(t) {
                ...
                if (n?.type !== e.message.scoreUpdate)
                    return;
                const o = Dn.get(n.message_id);
                o && (Dn.delete(n.message_id),
                    o(n.leaderboards),
                    0 === Dn.size && (window.removeEventListener("message", Ln),
                        On = !1))
            }
            let Mn = 0;
            function Bn() {
            ...
            const Rn = class {
                ...
                init = (t = {}) => {
                    if (this.__logCall("init", t),
                        this.#S)
                        return Y("PokiSDK.init() called more than once"),
                            this.#S;
                    t[Nn] && t[Nn]((t, n) => async function (t, n) {
                        const o = {
                            time_on_page: performance.now(),
                            p4d_version_id: U.versionID,
                            sdk_version: "9daf7c2c9706644c9c30453f559ed7eb1674e231"
                        };
                        On || (On = !0,
                            window.addEventListener("message", Ln));
                        const r = (Cn++).toString(36);
                        return V.sendMessage(e.message.sendScore, {
                            data: {
                                leaderboard: t,
                                score: n,
                                meta: o,
                        ...
                        window.addEventListener("pointerdown", this.#E),
                    ...
                    if (n.engine?.config?.onPrint) {
                        ...
                        n.engine.config.onPrint = (...t) => {
                            ...
                            o && o[1] && (!function (e) {
                                ...
                                n.engine.config.onPrint = e)
                        }
                    }
                    return this.#S = new Promise(n => {
                        this.__monetization.init({
                            onReady: () => {
                                O("preroll") && this.__monetization.forcePreroll(),
                                    n()
                            }
                            ,
                            ...t
                            ...
                            this.#I(),
                            U.isInspector && this.#_(),
                            document.location.search.length <= 1 && V.sendMessage(e.message.sendInspectorEvent, {
                                event: "bad-behavior",
                                data: {
                                    behavior: "rewrite_query_params"
                                }
                            }),
                            V.sendMessage(e.message.sdkDetails, {
                                version: "9daf7c2c9706644c9c30453f559ed7eb1674e231"
                            })
                    }
                    ),
                        this.#S
                    ...
                    window.addEventListener("message", async t => {
                        if ("pokiGenerateScreenshot" === t.data.type)
                            (async t => {
                                ...
                                t.callback && (r.callback = t.callback),
                                    V.sendMessage(e.message.sendGameScreenshot, {
                                        data: r
                                    })
                            }
                            )(t.data);
                            ...
                            (async () => {
                                const t = await kt();
                                V.sendMessage(e.message.sendGameRawScreenshot, {
                                    data: {
                                        screenshot: t
                                    }
                                })
                            ...
                            const n = await bt(t.data);
                            V.sendMessage(e.message.sendUploadScreenshot, {
                                data: {
                                    screenshot: n
                                }
                            })
                ...
                #_ = () => {
                    if (window.addEventListener("message", async t => {
                        if ("pokiInspectorAllowCommercialBreak" === t.data.type && (F("adOverrideMode", !0),
                            F("houseAdsOnly", !0)),
                            "pokiInspectorDisallowCommercialBreak" === t.data.type && (F("adOverrideMode", !1),
                                F("houseAdsOnly", !1)),
                            "pokiInspectorRequestCookies" === t.data.type && Se().then(t => {
                                V.sendMessage(e.message.sendInspectorCookies, {
                                    data: {
                                        cookies: t
                                    }
                                }),
                                    V.sendMessage(e.message.sendInspectorEvent, {
                                        event: "cookies",
                                        data: {
                                            cookies: t
                                        }
                            ...
                            try {
                                if (localStorage.clear(),
                                    ...
                                    t.length > 0 && W("PokiSDK: Some IndexedDB databases failed to delete", t)
                                }
                                ...
                                W("PokiSDK: Error clearing localStorage", t),
                                    V.sendMessage(e.message.sendInspectorEvent, {
                        ...
                        try {
                            const t = t => {
                                const n = console[t];
                                console[t] = (...o) => {
                                    V.sendMessage(e.message.sendInspectorConsole, {
                                        data: {
                                            level: t,
                                            args: ne(o)
                                        }
                ...
                setDebug = (t = !0) => {
                    ...
                    const { hostname: n } = window.location;
                    n.endsWith("poki-gdn.com") || n.endsWith("gdn.poki.com") ? t && X.track(e.tracking.debugTrueInProduction) : (G.debug = t,
                        G.log = t ?? G.log,
                        t ? function () {
                            if (de) {
                                de = !1,
                                    window.removeEventListener("unhandledrejection", me),
                ...
                gameLoadingFinished = () => {
                    this.__logCall("gameLoadingFinished"),
                        ...
                        X.track(e.tracking.screen.gameLoadingFinished, {
                            transferSize: St(),
                            trackers: ee().join(","),
                            error_session_id: le,
                    ...
                    if (this.__logCall("gameplayStart", t),
                        ...
                        try {
                            if (window.ysdk?.features?.LoadingAPI?.ready) {
                                ...
                                console.log("[YSDK] LoadingAPI.ready() called from PokiSDK.gameplayStart");
                            } else {
                                console.warn("[YSDK] LoadingAPI.ready() not available in gameplayStart");
                            }
                        } catch (err) {
                            console.warn("[YSDK] LoadingAPI.ready() failed in gameplayStart", err);
                        }
                    }

                    if (this.#x())
                        return void W("PokiSDK.gameplayStart() ignored because of too many events");

                    this.#f = !0,
                        this.__gameStarted || (this.__gameStarted = !0,
                            X.track(e.tracking.screen.firstRound),
                            this.__monetization.startStartAdsAfterTimer());

                    const n = this.#w;
                    setTimeout(() => {
                        let o;
                        performance.now() - Bn() < 5e3 && (o = this.#h),
                            X.track(e.tracking.screen.gameplayStart, {
                                ...t,
                                fps: this.#g.stats(),
                                badEvents: n,
                                interaction: o
                        ...
                        clearTimeout(this.#m),
                        this.#m = setTimeout(() => {
                            window.addEventListener("pointermove", this.#P),
                                document.addEventListener("keydown", this.#P)
                        }, 6e5),
                        this.#y && (this.#y > performance.now() - 50 && this.#w++,
                            this.#y = 0)
                };
                gameplayStop = t => {
                    this.__logCall("gameplayStop", t),
                        this.#x() ? W("PokiSDK.gameplayStart() ignored because of too many events") : (this.#f = !1,
                            X.track(e.tracking.screen.gameplayStop, {
                                ...t,
                                fps: this.#g.stats()
                            }),
                            clearTimeout(this.#m),
                            window.removeEventListener("pointermove", this.#P),
                ...
                openExternalLink = t => {
                    this.__logCall("openExternalLink", t),
                        V.sendMessage(e.message.openExternalLink, {
                            params: {
                                url: t
                            }
                        })
                    ...
                    ;
                customEvent = (t, n, o = {}) => {
                    this.__logCall("customEvent", t, n, o),
                        t && n ? (t = String(t),
                            n = String(n),
                            o = {
                                ...o
                            },
                            "game" === t && "segment" === n && o.segment || X.track(e.tracking.custom, {
                                eventNoun: t,
                                eventVerb: n,
                                eventData: o
                ...
                commercialBreak = t => new Promise(n => {
                    /*if (this.__logCall("commercialBreak", t),
                        "977b60eb-ff81-4c3a-895b-b585410d6c0d" === U.gameID)
                        return void n();*/
                    if (this.#x())
                        return W("PokiSDK.commercialBreak() ignored because of too many calls"),
                            void n();
                    ...
                    this.__runVideoAd({
                        ...
                        onStart: () => {
                            if (this.#v++,
                                window.pokiMeasureBuildin && window.PokiSDK.measure("midroll", this.#v),
                                "function" == typeof t)
                                try {
                                    t()
                                } catch (e) {
                                    W("error in onStart callback of PokiSDK.commercialBreak()", e)
                                }
                        }
                    }).then(() => {
                        n()
                ...
                rewardedBreak = t => new Promise(n => {
                   /* if (this.__logCall("rewardedBreak", t),
                    ...
                    if ("function" == typeof t)
                        ...
                        const e = t?.size || we.SMALL;
                        e === we.SMALL ? r = 1 : e === we.MEDIUM ? r = 2 : e === we.LARGE && (r = 3)
                    }
                    setTimeout(() => {
                        this.__runVideoAd({
                            ...
                            onStart: () => {
                                if (this.#b++,
                                    window.pokiMeasureBuildin && window.PokiSDK.measure("rewarded", this.#b),
                                    "function" == typeof o)
                                    try {
                                        o()
                                    } catch (e) {
                                        W("error in onStart callback of PokiSDK.rewardedBreak()", e)
                                    }
                            }
                        }).then(e => {
                            n(e)
                ...
                displayAd = (t, n, o, r) => {
                    if (this.__logCall("displayAd", t, n, o, r),
                        "977b60eb-ff81-4c3a-895b-b585410d6c0d" === U.gameID)
                        return void (o && o());
                    const i = ye();
                    X.track(e.tracking.screen.displayAd, {
                        size: n,
                        opportunityId: i,
                        duringGameplay: this.#f
                    });
                    const a = {
                        container: t,
                        opportunityId: i,
                ...
                shareableURL = (t = {}) => new Promise((n, o) => {
                    ...
                    const r = new URLSearchParams
                        , i = Object.keys(t);
                    if (U.isPokiIframe || U.isInspector) {
                        const o = O("poki_url");
                        i.forEach(e => {
                            ...
                            n(`${o}?${r.toString()}`),
                            V.sendMessage(e.message.setPokiURLParams, {
                                params: t
                            })
                    } else
                        window.self === window.top ? (i.forEach(e => {
                ...
                movePill = (e, t) => {
                    this.__logCall("movePill", e, t),
                        ...
                        }, "*") : W("PokiSDK.movePill() called with invalid parameters", e, t)
                }
                    ;
                ...
                generateScreenshot = async () => (this.__logCall("generateScreenshot"),
                    At());
                showLeaderboard = t => {
                    V.sendMessage(e.message.showLeaderboard, {
                        data: {
                ...
                enableEventTracking = e => {
                    this.__logCall("enableEventTracking", e),
                        U.isPlayground || U.isPokiIframe || U.isInspector || document?.referrer?.includes("games.poki.com") || X.setupObserverWithCMP(e || 0)
                }
                    ;
                __runVideoAd = ({ position: t, amount: n, onStart: o, timeBetweenAds: r, platformAd: i }) => new Promise(a => {
                    let s = 1;
                    this.__monetization.setNrAds(s, n);
                    const c = ye()
                        , d = o => {
                            setTimeout(() => {
                                if (o?.type === e.ads.limit || o?.type === e.ads.busy || o?.type === e.ads.stopped)
                                    return void a(!1);
                                if (s === n || this.#A)
                                    return H.dispatchEvent(e.ads.startTimer, {
                                        overwriteTimeBetweenAds: r
                                    }),
                                        void a(!!o?.rewardAllowed);
                                const l = H.getVideoDataAnnotations();
                                if ("poki" === l?.bidder)
                                    return H.dispatchEvent(e.ads.startTimer, {
                                        overwriteTimeBetweenAds: r
                                    }),
                    ...
                    H.clearVideoDataAnnotations(),
                        ...
                        this.__monetization.requestAd({
                            ...
                            onFinish: d,
                            onStart: () => {
                                if (this.__monetization.setNrAds(s, n),
                                    "function" == typeof o)
                                    try {
                                        o()
                                    } catch (e) {
                ...
                #P = () => {
                    window.removeEventListener("pointermove", this.#P),
                        document.removeEventListener("keydown", this.#P),
                        X.track(e.tracking.screen.playerActive),
                        this.#m = setTimeout(() => {
                            window.addEventListener("pointermove", this.#P),
                                document.addEventListener("keydown", this.#P)
                        }
                ...
                #E = e => {
                    var t;
                    "pointerdown" === e.type ? this.#h = "pointerdown" : "keydown" === e.type ? this.#h = `keydown-${e.code}` : this.#h = "unknown",
                        t = performance.now(),
                        Mn = t
                }
                    ;
            ...
            function Fn(e) {
                ...
                return G.debug || (t = U.isPokiIframe ? `/21682198607/${U.device}_ingame_${e}/${U.siteID}_${U.device}_ingame_${e}` : U.isPokiExternal ? `/21682198607/external_${U.device}_display_platform` : `/21682198607/external_${U.device}_display_ingame/external_${U.device}_ingame_${e}`),
                    t
            }
            const Un = () => {
                ...
                return vt(`https://devs-api.poki.com/gameinfo/@sdk?href=${encodeURIComponent(`${window.location.protocol}//${window.location.host}${e}${window.location.search}`)}&referrer=${t}`, {
                    method: "GET",
                    headers: {
                        "Content-Type": "text/plain"
                    }
            ...
            function Vn() {
                ...
                e?.removeEventListener("pointerdown", Vn),
                    t?.removeEventListener("pointerdown", Vn),
            ...
            function zn({ gameTitle: e, rejectCallback: t, resolveCallback: n }) {
                ...
                r.querySelector("#poki-playtest-popup-game-title").textContent = e,
                    async function () {
                        ...
                        o.appendChild(r),
                            function ({ rejectCallback: e, resolveCallback: t }) {
                                ...
                                r && ["pointerdown", "pointerup", "pointermove", "click", "mousedown", "mouseup", "mousemove", "touchstart", "touchend", "touchmove", "contextmenu", "dragstart"].forEach(e => r.addEventListener(e, Gn))
                            }({
                                rejectCallback: t,
                                resolveCallback: n
                            })
            ...
            function Kn(e) {
                ...
                for (let o = 0; o < e.length; o++) {
                    ...
                    const r = e[o];
                    if ("string" == typeof r)
                        n = (r.match(/%c/g) || []).length,
                            t.push(r.replace(/%c/g, ""));
                    else
                        try {
                            t.push(String(r))
                        } catch (e) {
            ...
            const Yn = window.requestAnimationFrame;
            function Jn(e) {
            ...
            let $n = !1;
            try {
                "1" === localStorage.getItem("poki_pbf") ? $n = !0 : U.isPlayground || "GB" === U.country || localStorage.setItem("poki_pbf", "1")
            } catch { }
            function Zn() {
                if (void 0 === window.MediaRecorder)
                    return;
                let e = 'video/webm;codecs="vp9"';
                return ("undefined" != typeof navigator && /(iPad|iPhone|iPod)/gi.test(navigator.userAgent) || Mt || Bt) && (e = 'video/mp4;codecs="avc1.42000d"'),
            ...
            let Xn = (e, t) => { }
                ...
                , to = null
                , no = 0;
            const oo = [...Object.values(e.tracking.screen), e.tracking.ads.status.completed, e.tracking.ads.status.error, e.tracking.ads.status.limit, e.tracking.ads.video.progress]
                , ro = {
            ...
            try {
                const e = e => {
                    ...
                    ;
                U.gameID && !U.isPlayground && !U.isPokiExternal && U.isPokiIframe && (e("log"),
                    e("info"),
                    e("warn"),
                    e("error"))
            } catch { }
            ...
            function co(t, n, o) {
                ...
                const r = In(t, () => {
                    to?.close(1e3, "Playtest recording stopped")
                }
                );
                r && (to = new WebSocket("wss://playtest-recorder.poki.io/ws"),
                    to.addEventListener("error", () => {
                        X.track(e.tracking.playtest.error, {
                    ...
                    to.addEventListener("open", () => {
                        ...
                        if (to.readyState === to.OPEN) {
                            ...
                            try {
                                ...
                                if (o || (o = t.getContext("webgl", n),
                                    o || (o = t.getContext("experimental-webgl", n))),
                                    o) {
                                    const t = o
                                        , n = t.getExtension("WEBGL_debug_renderer_info");
                                    n && (e = t.getParameter(n.UNMASKED_RENDERER_WEBGL)),
                            ...
                            to.send(n),
                                console.info("%cPOKI_PLAYTEST:%c websocket open", "font-weight: bold", "", n)
                        }
                        ...
                        i.addEventListener("stop", () => {
                            ...
                            i.addEventListener("dataavailable", e => {
                                e.data.size > 0 && to && to.readyState === to.OPEN && to.send(e.data)
                            }
                            ),
                            i.start(250);
                        const c = {};
                        ...
                        const l = setInterval(() => {
                            ...
                            d && e.length > 0 && to && to.readyState === to.OPEN && to.send(JSON.stringify({
                                type: "keyboard",
                                offset: s(),
                                keys: c
                            })),
                        ...
                        Xn = (e, t) => {
                            ...
                            null !== eo && (eo.forEach(e => {
                                ...
                                eo = null),
                            ue = e => {
                                to && to.readyState === to.OPEN && to.send(JSON.stringify({
                                    type: "error",
                                    offset: s(),
                                    error: e
                                }))
                        ...
                        const u = ({ position: t }) => {
                            ...
                            let n = e.tracking.screen.commercialBreak
                                , o = "Commercial Break";
                            t === e.ads.position.rewarded && (n = e.tracking.screen.rewardedBreak,
                                o = "Rewarded Break"),
                                An(o),
                            ...
                            ;
                        H.addEventListener(e.playtest.startVideo, u);
                        const p = () => {
                            An("")
                        }
                            ;
                        H.addEventListener(e.playtest.stopVideo, p);
                        const f = new ke(1)
                            , m = setInterval(() => {
                                to && to.readyState === to.OPEN && to.send(JSON.stringify({
                                    type: "fps",
                                ...
                                , 1e3);
                        to.addEventListener("close", t => {
                            console.info("%cPOKI_PLAYTEST:%c websocket closed", "font-weight: bold", "", t),
                                Xn = () => { }
                                ,
                                H.removeEventListener(e.playtest.startVideo, u),
                                H.removeEventListener(e.playtest.stopVideo, p),
                                clearInterval(l),
                                clearInterval(m),
                                i.stop(),
                                Kt = !0,
                                to = null,
                                so(),
                                X.track(e.tracking.playtest.closed, {
            ...
            Q = function (t) {
                ...
                if (n = performance.now(),
                    qn = n,
                    t.event === e.tracking.screen.gameLoadingFinished ? no = performance.now() : t.event === e.tracking.screen.gameplayStart && function (e) {
                        Hn = e
                    }(performance.now()),
                    oo.includes(t.event))
                    try {
            ...
            function lo(t) {
                const n = function (e) {
                    ...
                    if (!e.playtestRecord)
                        return !1;
                    if (e.playtestVersion && e.playtestVersion !== U.versionID)
                        return !1;
                    if (e.playtestNewUser && $n)
                        return !1;
                    const t = D() || L() || Mt;
                ...
                if (n && o && !r) {
                    var i;
                    X.track(e.tracking.playtest.showModal, {
                        show: !0
                    }),
                        console.info("%cPOKI_PLAYTEST:%c init", "font-weight: bold", "", o),
                        (i = t?.gameTitle || "this game",
                            new Promise((e, t) => {
                                ...
                                X.track(e.tracking.playtest.accepted);
                                ...
                                const a = setInterval(() => {
                                    ...
                                    if (!function () {
                                        ...
                                        t !== r && (r = t,
                                            i = s),
                                            (no && s - no > 1e4 || s - i > 1e4) && (X.track(e.tracking.playtest.noCanvas),
                                    ...
                                    if (c.length) {
                                        clearInterval(a),
                                            X.track(e.tracking.playtest.starting);
                                        try {
                                            co(c, o, t.playtestRequestID)
                                        } catch { }
                                    }
                                    s > n && (X.track(e.tracking.playtest.notLoaded),
                                        clearInterval(a),
                                ...
                                X.track(e.tracking.playtest.rejected),
                                    console.info("%cPOKI_PLAYTEST:%c rejected", "font-weight: bold", "", t),
                                    so()
                            }
                            )
                } else {
                    if (r || t.metrictestID && U.isPokiIframe) {
                        const n = Qn(t);
                        X.track(e.tracking.playerfittest.starting, {
                            playId: n
                        })
                    }
                    so()
                ...
                return t && function (e, t) {
                    for (var n = 0; n < t.length; n++) {
                        ...
                        o.enumerable = o.enumerable || !1,
                            ...
                            Object.defineProperty(e, wo(o.key), o)
                    }
                }(e.prototype, t),
                    ...
                    if (null != n) {
                        ...
                        try {
                            if (i = (n = n.call(e)).next,
                                ...
                                for (; !(c = (o = i.call(n)).done) && (s.push(o.value),
                                    s.length !== t); c = !0)
                                    ;
                        } catch (e) {
                            d = !0,
            ...
            var ko = fo(function e(t) {
                po(this, e),
                    this.p = new Promise(t)
            });
            ko.__typeson__type__ = "TypesonPromise",
                "undefined" != typeof Symbol && Object.defineProperty(ko.prototype, Symbol.toStringTag, {
                    get: function () {
                        return "TypesonPromise"
                    }
                }),
                ko.prototype.then = function (e, t) {
                    var n = this;
                    return new ko(function (o, r) {
                        n.p.then(function (t) {
                            o(e ? e(t) : t)
                        }).catch(function (e) {
                ...
                ,
                ko.prototype.catch = function (e) {
                    return this.then(function () { }, e)
                }
                ,
                ko.resolve = function (e) {
                    return new ko(function (t) {
                        t(e)
                    }
                    )
                }
                ,
                ko.reject = function (e) {
                    return new ko(function (t, n) {
                        n(e)
                    }
                    )
                }
            ...
            function _o(e, t) {
                ...
                if (!n)
                    return null === t;
                var o = Ao(n, "constructor") && n.constructor;
            ...
            function xo(e) {
                return !(!e || "Object" !== Io(e)) && (!So(e) || _o(e, Object))
            }
            function Po(e) {
                if (!e || "Object" !== Io(e))
                    return !1;
                var t = So(e);
                return !t || _o(e, Object) || Po(t)
            }
            function To(e) {
                return null !== e && "object" === vo(e)
            }
            function Co(e) {
            ...
            function Lo(e, t, n) {
                ...
                var o = t.indexOf(".");
                return -1 !== o ? Lo(e[Oo(t.slice(0, o))], t.slice(o + 1), n) : (e[Oo(t)] = n,
                    e)
            }
            function Mo(e) {
                return null === e ? "null" : Array.isArray(e) ? "array" : vo(e)
            }
            function Bo(e, t, n) {
            ...
            var No = Object.keys
                , Ro = Object.hasOwn
                , jo = Array.isArray
                , Fo = ["type", "replaced", "iterateIn", "iterateUnsetNumeric", "addLength"];
            function Uo(e) {
                return function () {
            ...
            function Vo(e, t) {
                ...
                return r && (r = r.length),
                    i && (i = i.length),
                    r > i ? -1 : r < i ? 1 : e.keypath < t.keypath ? -1 : e.keypath > t.keypath ? 1 : 0
            }
            var Go = fo(function e(t) {
                po(this, e),
                    this.options = t,
                ...
                value: function (e, t, n, o) {
                    o = ho(ho(ho({}, this.options), o), {}, {
                        stringification: !0
                    });
                    var r = this.encapsulate(e, null, o);
                    return jo(r) ? JSON.stringify(r[0], t, n) : r.then(function (e) {
                ...
                key: "stringifySync",
                value: function (e, t, n, o) {
                    return this.stringify(e, t, n, ho(ho({
                ...
                value: function (e, t, n) {
                    return n = ho(ho(ho({}, this.options), n), {}, {
                        parse: !0
                    }),
                ...
                value: function (e, t, n) {
                    var o = this
                        ...
                        , f = Uo(function (e, t) {
                            return Bo(Promise.all(t.map(function (e) {
                                return e[1].p
                            })), function (n) {
                                return Bo(Promise.all(n.map(Uo(function (n) {
                                    var o = !1
                                        , r = []
                                        , i = yo(t.splice(0, 1), 1)
                                        , a = yo(i[0], 7)
                        ...
                        , m = function (e, t, n) {
                            Object.assign(e, t);
                            var o = Fo.map(function (t) {
                                var n = e[t];
                                return delete e[t],
                                    n
                            });
                            n(),
                                Fo.forEach(function (t, n) {
                                    e[t] = o[n]
                                })
                        }
                        , g = function (e, t, n, i, d, l, p) {
                            var f, y = {}, w = vo(t), v = u ? function (o) {
                                var r, a = null !== (r = null != p ? p : i.type) && void 0 !== r ? r : Mo(t);
                                u(Object.assign(null != o ? o : y, {
                                    ...
                                    awaitingTypesonPromise: _o(t, ko)
                                }, {
                                    type: a
                                }))
                            }
                                : null;
                            if (["string", "boolean", "number", "undefined"].includes(w))
                                return void 0 === t || Number.isNaN(t) || t === Number.NEGATIVE_INFINITY || t === Number.POSITIVE_INFINITY || 0 === t ? (f = i.replaced ? t : h(e, t, i, d, !1, l, v)) !== t && (y = {
                                    replaced: f
                                }) : f = t,
                                    v && v(),
                                    f;
                            if (null === t)
                                return v && v(),
                                    t;
                            if (n && !i.iterateIn && !i.iterateUnsetNumeric && t && "object" === vo(t)) {
                                var b = s.indexOf(t);
                                if (-1 !== b)
                                    return a[e] = "#",
                                        v && v({
                            ...
                            var k, A = xo(t), S = jo(t), E = (A || S) && (!o.plainObjectReplacers.length || i.replaced) || i.iterateIn ? t : h(e, t, i, d, A || S, null, v);
                            if (E !== t ? (f = E,
                                y = {
                                    replaced: E
                                }) : "" === e && _o(t, ko) ? (d.push([e, t, n, i, void 0, void 0, i.type]),
                                    f = t) : S && "object" !== i.iterateIn || "array" === i.iterateIn ? (k = new Array(t.length),
                                        y = {
                                            clone: k
                                        }) : (["function", "symbol"].includes(vo(t)) || "toJSON" in t || _o(t, ko) || _o(t, Promise) || _o(t, ArrayBuffer)) && !A && "object" !== i.iterateIn ? f = t : (k = {},
                                            i.addLength && (k.length = t.length),
                                            y = {
                                                clone: k
                                            }),
                                v && v(),
                            ...
                            if (i.iterateIn) {
                                var I = function (o) {
                                    ...
                                    m(i, r, function () {
                                        ...
                                        _o(a, ko) ? d.push([r, a, Boolean(n), i, k, o, i.type]) : void 0 !== a && (k[o] = a)
                                    })
                                };
                                for (var _ in t)
                                    I(_);
                                ...
                                No(t).forEach(function (o) {
                                    ...
                                    m(i, {
                                        ...
                                        _o(e, ko) ? d.push([r, e, Boolean(n), i, k, o, i.type]) : void 0 !== e && (k[o] = e)
                                    })
                                }),
                                    v && v({
                                        endIterateOwn: !0,
                            ...
                            if (i.iterateUnsetNumeric) {
                                for (var x = t.length, P = function (o) {
                                    if (!(o in t)) {
                            ...
                            for (var u = s ? o.plainObjectReplacers : o.nonplainObjectReplacers, p = u.length; p--;) {
                                ...
                                if (f.test(t, n)) {
                                    ...
                                    if (i || !f.replaceAsync) {
                                        ...
                                        y = f.replaceAsync(t, n);
                                    return g(e, y, l && "readonly", n, r, c, m)
                                }
                            }
                            return t
                        }
                        , y = g("", e, l, null != t ? t : {}, d);
                    if (d.length)
                        return i && r.throwOnBadSyncType ? function () {
                            throw new TypeError("Sync method requested but async result obtained")
                        }() : Promise.resolve(f(y, d)).then(p);
                    if (!i && r.throwOnBadSyncType)
                ...
                key: "encapsulateSync",
                value: function (e, t, n) {
                    return this.encapsulate(e, t, ho(ho({
                        throwOnBadSyncType: !0
                    }, n), {}, {
                        sync: !0
                    }))
                ...
                value: function (e, t) {
                    ...
                    function i(e) {
                        if (r)
                            return e;
                        if (o.throwOnBadSyncType)
                            throw new TypeError("Async method requested but sync result obtained");
                        return Promise.resolve(e)
                    }
                    if (!e || "object" !== vo(e) || Array.isArray(e))
                        return i(e);
                    var a = e.$types;
                    if (!0 === a)
                        return i(e.$);
                    if (!a || "object" !== vo(a) || Array.isArray(a))
                        return i(e);
                    var s = []
                        , c = {}
                        , d = !0;
                    a.$ && xo(a.$) && (e = e.$,
                        ...
                        d = !1);
                    var l = function (e, t) {
                        var o, i = yo(null !== (o = n.revivers[e]) && void 0 !== o ? o : [], 1)[0];
                        if (!i)
                    ...
                    var f, m = function () {
                        ...
                        if (Object.entries(a).forEach(function (e) {
                            ...
                            "#" !== i && [].concat(i).forEach(function (e) {
                                var o;
                                yo(null !== (o = n.revivers[e]) && void 0 !== o ? o : [null, {}], 2)[1].plain && (t.push({
                                    keypath: r,
                                    type: e
                                }),
                                    delete a[r])
                    ...
                    return _o(m, ko) ? f = m.then(function () {
                        return e
                        ...
                        if (!d || "$types" !== t) {
                            ...
                            if (p || xo(n)) {
                                ...
                                for (No(n).forEach(function (r) {
                                    var i = e(t + (t ? "." : "") + Co(r), n[r], null != o ? o : f, f, r)
                                        , a = function (e) {
                                            return _o(e, zo) ? f[r] = void 0 : void 0 !== e && (f[r] = e),
                                                e
                                        };
                                    _o(i, ko) ? u.push(i.then(function (e) {
                                        return a(e)
                                    })) : a(i)
                                }),
                                    n = f; s.length;) {
                            ...
                            if (!c)
                                return n;
                            if ("#" === c) {
                                var b = Do(o, n.slice(1));
                                return void 0 === b && s.push([o, n.slice(1), r, i]),
                                    b
                            }
                        ...
                        u.length && (f = ko.resolve(f).then(function (e) {
                            return ko.all([e].concat(u))
                        }).then(function (e) {
                            return yo(e, 1)[0]
                        }))),
                        Eo(f) ? r && o.throwOnBadSyncType ? function () {
                            throw new TypeError("Sync method requested but async result obtained")
                        }() : _o(f, ko) ? f.p.then(p) : f : !r && o.throwOnBadSyncType ? function () {
                            throw new TypeError("Async method requested but sync result obtained")
                        }() : r ? p(f) : Promise.resolve(p(f))
                }
            }, {
                key: "reviveSync",
                value: function (e, t) {
                    return this.revive(e, ho(ho({
                        throwOnBadSyncType: !0
                    }, t), {}, {
                        sync: !0
                    }))
                        ...
                        , r = function (e) {
                            jo(e) ? e.forEach(function (e) {
                                ...
                                if (null !== (r = i) && void 0 !== r && r.test) {
                                    ...
                                    if (i.testPlainObjects ? n.plainObjectReplacers.splice(u, 0, l) : n.nonplainObjectReplacers.splice(u, 0, l),
            ...
            zo.__typeson__type__ = "TypesonUndefined";
            for (var Ko = ["null", "boolean", "number", "string", "array", "object"], Ho = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", qo = new Uint8Array(256), Wo = 0; Wo < 64; Wo++)
                qo[Ho.codePointAt(Wo)] = Wo;
            var Yo = function (e, t, n) {
                null == n && (n = e.byteLength);
                for (var o = new Uint8Array(e, 0, n), r = o.length, i = "", a = 0; a < r; a += 3)
                    i += Ho[o[a] >> 2],
                        i += Ho[(3 & o[a]) << 4 | o[a + 1] >> 4],
                        i += Ho[(15 & o[a + 1]) << 2 | o[a + 2] >> 6],
                        i += Ho[63 & o[a + 2]];
                return r % 3 == 2 ? i = i.slice(0, -1) + "=" : r % 3 == 1 && (i = i.slice(0, -2) + "=="),
                    i
            }
                , Jo = function (e, t) {
                    var n = e.length;
                    ...
                    var o, r, i, a, s = .75 * e.length, c = 0;
                    "=" === e[e.length - 1] && (s--,
                        "=" === e[e.length - 2] && s--);
                    for (var d = new ArrayBuffer(s, t), l = new Uint8Array(d), u = 0; u < n; u += 4)
                        o = qo[e.codePointAt(u)],
                            r = qo[e.codePointAt(u + 1)],
                            i = qo[e.codePointAt(u + 2)],
                            a = qo[e.codePointAt(u + 3)],
                            l[c++] = o << 2 | r >> 4,
                            l[c++] = (15 & r) << 4 | i >> 2,
                            l[c++] = (3 & i) << 6 | 63 & a;
                    return d
            ...
            const Qo = {
                ...
                , $o = {
                    bigintObject: {
                        test: e => "object" == typeof e && _o(e, BigInt),
                        replace: String,
            ...
            const tr = {
                blob: {
                    ...
                    revive(e) {
                        const { type: t, stringContents: n } = e;
                        return new Blob([er(n)], {
                            type: t
                        })
                    },
                    replaceAsync: e => new ko((t, n) => {
                        const o = new FileReader;
                        o.addEventListener("load", () => {
                            t({
                                type: e.type,
                                stringContents: Xo(o.result)
                            })
                        }
                        ),
            ...
            const nr = {
                cryptokey: {
                    test: e => "CryptoKey" === Io(e) && e.extractable,
                    replaceAsync: e => new ko(async (t, n) => {
                        let o;
                        try {
                    ...
                    revive(e) {
                        const { jwk: t, algorithm: n, usages: o } = e;
                ...
                , or = {
                    dataview: {
                        test: e => "DataView" === Io(e),
                        replace({ buffer: e, byteOffset: t, byteLength: n }, o) {
                            o.buffers || (o.buffers = []);
                        ...
                        revive(e, t) {
                            t.buffers || (t.buffers = []);
                            const { byteOffset: n, byteLength: o, encoded: r, index: i, maxByteLength: a, resizable: s } = e;
                            let c;
                            return "index" in e ? c = t.buffers[i] : (c = Jo(r, s ? {
                                maxByteLength: a
                            } : a),
                                t.buffers.push(c)),
                                new DataView(c, n, o)
                ...
                , ir = {
                    domexception: {
                        test: e => "DOMException" === Io(e),
                        replace: e => ({
                            name: e.name,
                            message: e.message
                        }),
                        revive: ({ message: e, name: t }) => new DOMException(e, t)
                    }
                }
                , ar = {};
            function sr(e) {
            ...
            "undefined" != typeof DOMMatrix && sr(DOMMatrix),
                "undefined" != typeof DOMMatrixReadOnly && sr(DOMMatrixReadOnly);
            const cr = {};
            function dr(e) {
                cr[e.name.toLowerCase()] = {
                    ...
                    revive: ({ x: t, y: n, z: o, w: r }) => new e(t, n, o, r)
                }
            }
            "undefined" != typeof DOMPoint && dr(DOMPoint),
                "undefined" != typeof DOMPointReadOnly && dr(DOMPointReadOnly);
            const lr = {
                domquad: {
                    test: e => "DOMQuad" === Io(e),
                    replace: e => ({
                    ...
                    revive: ({ p1: e, p2: t, p3: n, p4: o }) => new DOMQuad(e, t, n, o)
                }
            }
                , ur = {};
            function pr(e) {
                ur[e.name.toLowerCase()] = {
                    ...
                    revive: ({ x: t, y: n, width: o, height: r }) => new e(t, n, o, r)
                }
            }
            "undefined" != typeof DOMRect && pr(DOMRect),
                "undefined" != typeof DOMRectReadOnly && pr(DOMRectReadOnly);
            const fr = {
                error: {
                    test: e => "Error" === Io(e),
                    replace: ({ name: e, message: t, cause: n, stack: o, fileName: r, lineNumber: i, columnNumber: a }) => ({
                        name: e,
                        message: t,
                        cause: n,
                        stack: o,
            ...
            function gr(e) {
                mr[e.name.toLowerCase()] = {
                    test: t => _o(t, e),
                    replace: ({ name: e, message: t, cause: n, stack: o, fileName: r, lineNumber: i, columnNumber: a, errors: s }) => ({
                        name: e,
                        message: t,
                        cause: n,
                        stack: o,
            ...
            [TypeError, RangeError, SyntaxError, ReferenceError, EvalError, URIError].forEach(e => gr(e)),
                "undefined" != typeof AggregateError && gr(AggregateError),
                "function" == typeof InternalError && gr(InternalError);
            const hr = {
                file: {
                    test: e => "File" === Io(e),
                    replace(e) {
                    ...
                    revive: ({ name: e, type: t, stringContents: n, lastModified: o }) => new File([er(n)], e, {
                        type: t,
                        lastModified: o
                    }),
                    replaceAsync: e => new ko(function (t, n) {
                        const o = new FileReader;
                ...
                , wr = {
                    imagebitmap: {
                        test: e => "ImageBitmap" === Io(e) || e && e.dataset && "ImageBitmap" === e.dataset.toStringTag,
                        replace(e) {
                            const t = document.createElement("canvas");
                ...
                , Ar = {
                    IntlCollator: kr,
                    IntlDateTimeFormat: {
                        test: e => _o(e, Intl.DateTimeFormat),
                        replace: e => e.resolvedOptions(),
                        revive: e => new Intl.DateTimeFormat(e.locale, e)
                    },
                    IntlNumberFormat: {
                        test: e => _o(e, Intl.NumberFormat),
                        replace: e => e.resolvedOptions(),
                ...
                , xr = {
                    StringObject: {
                        test: e => "String" === Io(e) && "object" == typeof e,
                        replace: String,
                        revive: e => new String(e)
                    },
                    BooleanObject: {
                        test: e => "Boolean" === Io(e) && "object" == typeof e,
                        replace: e => e.valueOf(),
                        revive: e => new Boolean(e)
                    },
                    NumberObject: {
                        test: e => "Number" === Io(e) && "object" == typeof e,
                        replace: Number,
                ...
                , Pr = {
                    regexp: {
                        ...
                        revive: ({ source: e, flags: t }) => new RegExp(e, t)
                    }
                }
                , Tr = {
                    set: {
            ...
            "function" == typeof Int8Array && [Int8Array, Uint8Array, Uint8ClampedArray, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, ..."function" == typeof BigInt64Array ? [BigInt64Array, BigUint64Array] : []].forEach(e => function (e) {
                ...
                Cr[t.toLowerCase()] = {
                    ...
                    revive: t => "ArrayBuffer" === Io(t) ? new e(t) : t
                }
            }(e));
            const Or = {};
            "function" == typeof Int8Array && [Int8Array, Uint8Array, Uint8ClampedArray, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, ..."function" == typeof BigInt64Array ? [BigInt64Array, BigUint64Array] : []].forEach(e => function (e) {
                ...
                Or[t.toLowerCase()] = {
                    test: e => Io(e) === t,
                    replace({ buffer: e, byteOffset: t, length: n }, o) {
                        o.buffers || (o.buffers = []);
                        const r = o.buffers.indexOf(e);
                        return -1 !== r ? {
                            index: r,
                    ...
                    revive(t, n) {
                        n.buffers || (n.buffers = []);
                        const { byteOffset: o, length: r, encoded: i, index: a, maxByteLength: s, resizable: c } = t;
                        let d;
                        return "index" in t ? d = n.buffers[a] : (d = Jo(i, c ? {
                            maxByteLength: s
                        } : void 0),
                            n.buffers.push(d)),
                            new e(d, o, r)
            ...
            const Dr = {
                ...
                , Mr = [{
                    arrayNonindexKeys: {
                        testPlainObjects: !0,
                        test: (e, t) => !!Array.isArray(e) && (Object.keys(e).some(e => String(Number.parseInt(e)) !== e) && (t.iterateIn = "object",
                            t.addLength = !0),
                            !0),
                        replace: (e, t) => (t.iterateUnsetNumeric = !0,
                            e),
                        revive(e) {
                            if (Array.isArray(e))
                                return e;
                ...
                , Br = [Er, br, Ir, _r]
                , Nr = ([Dr, Mr, xr, Br, rr, fr, mr, Pr].concat("function" == typeof Map ? Sr : [], "function" == typeof Set ? Tr : [], "function" == typeof ArrayBuffer ? Qo : [], "function" == typeof Uint8Array ? Or : [], "function" == typeof DataView ? or : [], "undefined" != typeof Intl ? Ar : [], "undefined" != typeof BigInt ? [Zo, $o] : []),
                    [Lr, Dr, Mr, xr, Br, rr, Pr, vr, wr, hr, yr, tr, fr, mr].concat("function" == typeof Map ? Sr : [], "function" == typeof Set ? Tr : [], "function" == typeof ArrayBuffer ? Qo : [], "function" == typeof Uint8Array ? Or : [], "function" == typeof DataView ? or : [], "undefined" != typeof crypto ? nr : [], "undefined" != typeof BigInt ? [Zo, $o] : [], "undefined" != typeof DOMException ? ir : [], "undefined" != typeof DOMRect ? ur : [], "undefined" != typeof DOMPoint ? cr : [], "undefined" != typeof DOMQuad ? lr : [], "undefined" != typeof DOMMatrix ? ar : []));
            Nr.concat({
            ...
            function Rr(e) {
                ...
                t.style.display = "none",
                    ...
                    t.contentWindow && (t.contentWindow.document.open(),
                        t.contentWindow.document.write(`<script>${e}<\/script>`),
                        t.contentWindow.document.close())
            }
            function jr(e, t, n, o, r, i) {
                return zr(function (e, t) {
                    return e << t | e >>> 32 - t
                }(zr(zr(t, e), zr(o, i)), r), n)
            }
            function Fr(e, t, n, o, r, i, a) {
                return jr(t & n | ~t & o, e, t, r, i, a)
            }
            function Ur(e, t, n, o, r, i, a) {
                return jr(t & o | n & ~o, e, t, r, i, a)
            }
            function Vr(e, t, n, o, r, i, a) {
                return jr(t ^ n ^ o, e, t, r, i, a)
            }
            function Gr(e, t, n, o, r, i, a) {
                return jr(n ^ (t | ~o), e, t, r, i, a)
            }
            function zr(e, t) {
            ...
            try {
                ...
                Hr = function (e) {
                    const t = function (e) {
                        for (var t, n = "0123456789ABCDEF", o = "", r = 0; r < e.length; r++)
                            t = e.charCodeAt(r),
                    ...
                    Kr = localStorage.getItem("savegame_idbfs_hash")
            } catch { }
            function qr(e) {
                if (!Kr)
                    return e;
                try {
                    return e.replace(Hr, Kr)
                } catch {
                    return e
                }
            }
            const Wr = 1e4
                , Yr = 2e4
                , Jr = "poki_gs_state_token"
                , Qr = "poki_playtime"
                , $r = "poki_ignore"
                , Zr = [Jr, Qr]
                , Xr = [];
            let ei = performance.now();
            function ti(e) {
                return !e || ("UnityCache" === e || ("EM_PRELOAD_CACHE" === e || "emscripten_filesystem" === e))
            }
            function ni(e) {
                return !e || (!!Zr.includes(e) || !!e.startsWith($r))
            }
            function oi(e, t) {
                return new Promise((n, o) => {
                    if (!e)
                        return void o(new Error("Cannot export database without a name"));
                    const r = indexedDB.open(e, t);
                    r.onsuccess = t => {
                        const r = t.target.result
                            , i = Array.from(r.objectStoreNames).filter(e => !function (e) {
                        ...
                        if (0 === s)
                            return r.close(),
                                void o(new Error(`Database ${e} has no exportable stores.`));
                        i.forEach(t => {
                            const o = r.transaction(t, "readonly").objectStore(t)
                                , i = Array.from(o.indexNames)
                                , c = []
                                , d = {
                                    name: t,
                                    keyPath: o.keyPath,
                            ...
                            l.onerror = () => {
                                console.warn(`%cPOKI_SAVEGAME:%c error fetching data from object store ${t}`, "font-weight: bold", ""),
                                    s--,
                                    0 === s && (r.close(),
                                        n(a))
                            }
                                ...
                                l.onsuccess = o => {
                                    ...
                                    if (null === l)
                                        return d.data = c,
                                            a.objectStores.push(d),
                                            s--,
                                            void (0 === s && (r.close(),
                                                n(a)));
                                    (function (e, t, n) {
                                        return !("string" != typeof n || ("/data" !== e || "FILE_DATA" !== t || !n.endsWith(".zip") && !n.includes("liveupdate.arc")) && !n.startsWith($r))
                                    }
            ...
            function ri() {
                ...
                const e = (new Go).register([Nr])
                    , t = () => {
                        const t = performance.now()
                            , n = Math.ceil((t - ei) / 1e3);
                        let o = 0;
                        try {
                            o = Number.parseInt(localStorage.getItem(Qr) || "0", 10)
                        } catch (e) {
                            W("error getting current playtime", e)
                        }
                        const r = o + n;
                        try {
                            localStorage.setItem(Qr, r.toString())
                        } catch (e) {
                            W("error setting current playtime", e)
                        }
                        ei = t;
                        try {
                            const t = {};
                            ...
                            (async function () {
                                if (!("databases" in indexedDB))
                                    return console.warn("%cPOKI_SAVEGAME:%c indexedDB.databases() is not supported in this browser.", "font-weight: bold", ""),
                                        [];
                                const e = await indexedDB.databases();
                                0 === e.length && (console.info("%cPOKI_SAVEGAME:%c No databases found, using IDBDatabaseInfos", "font-weight: bold", "", Xr.map(e => e.name)),
                                    e.push(...Xr));
                                const t = [];
                                return e.forEach(async e => {
                                    ti(e.name) || t.push(oi(e.name || "", e.version))
                                }
                                ),
                                    (await Promise.allSettled(t)).filter(e => "fulfilled" === e.status).map(e => e.value)
                            }
                            )().then(o => {
                                const i = {
                                    ls: JSON.stringify(t),
                ...
                function n(e, t) {
                    ...
                    Xr.find(n => n.name === e && n.version === t) || Xr.push(n)
                }
                Rr(`(${function () {
                    window.addEventListener("storage", e => {
                        e.key && (["poki_gs_state_token", "poki_playtime", "savegame_idbfs_hash"].includes(e.key) || e.key.startsWith("poki_ignore")) || window?.parent?.postMessage({
                    ...
                    .toString()})();`);
                const o = function (e, t = 300, n = 1e3) {
                    let o, r;
                    return function (...i) {
                        const a = this
                            , s = () => {
                ...
                window.addEventListener("message", async e => {
                    if ("LocalStorageChanged" === e?.data?.type)
                        return console.info("%cPOKI_SAVEGAME:%c localStorage Pulse", "font-weight: bold", ""),
                            void o();
                    "pokiSetEtag" === e?.data?.type && (e => {
                        const { etag: t } = e.data;
                        try {
                            localStorage.setItem(Jr, t)
                        } catch (e) {
                            W("error setting etag", e)
                        }
                    }
                    )(e)
                }
                ...
                const r = (e, t) => {
                    ti(e) ? console.info(`Skip IDB Pulse - DB: ${e}, action: ${t}`) : o()
                }
                ...
                window.IDBObjectStore.prototype.put = function (...e) {
                    ...
                    return r(this.transaction.db.name, "put"),
                        t
                }
                    ;
                ...
                window.IDBObjectStore.prototype.add = function (...e) {
                    ...
                    return r(this.transaction.db.name, "add"),
                        t
                }
                    ;
                ...
                window.IDBObjectStore.prototype.delete = function (...e) {
                    ...
                    return r(this.transaction.db.name, "delete"),
                        t
                }
                    ;
                ...
                window.IDBObjectStore.prototype.clear = function (...e) {
                    ...
                    return r(this.transaction.db.name, "clear"),
                        t
                }
                    ;
                const d = indexedDB.open.bind(indexedDB);
                indexedDB.open = function (e, t) {
                    return e && n(e, "number" == typeof t ? t : 1),
                        d(e, t)
                }
            }
            const ii = "none"
            ...
            class si {
                ...
                #T = {};
                #C = jn.adTiming;
                #O = new MutationObserver(this.mutationObserved.bind(this));
                #D = ii;
                #L;
                #M = !1;
                init = e => {
                    ...
                    U.isPokiIframe && setTimeout(Ee.trackSavegames, 1e4),
                        U.cloudSaveGames && ri(),
                        U.kioskMode && document.addEventListener("keydown", e => {
                    ...
                    if (G.debug)
                        return void n();
                    Un().then(e => {
                        if (this.#C = e?.adTiming || jn.adTiming,
                            this.#L = e?.specialConditions || [],
                            D() ? this.#C = {
                                startAdsAfter: 36e4,
                                timeBetweenAds: 36e4
                            } : L() ? this.#C = {
                ...
                requestAd(t) {
                    const { onStart: n, onFinish: o, position: r, customCriteria: i } = t
                        , a = ye();
                    if (this.#D === ii)
                        this.#D = ai,
                            this.#T[a] = {
                ...
                displayAd(e) {
                    ...
                    return this.#T[o] = {
                        ...
                        this.#O.observe(t.parentElement || document.body, {
                            childList: !0
                        }),
                        this.#O.observe(t, {
                            attributes: !0,
                ...
                destroyAd(e) {
                    if (!e)
                        return void console.error("%cPOKI:%c PokiSDK.destroyAd() given container does not exist", "font-weight: bold", "");
                ...
                mutationObserved(e) {
                    e.forEach(e => {
                        ...
                        "childList" === e?.type && e.removedNodes?.forEach?.(e => {
                            ...
                            "attributes" === e?.type && e?.target?.getAttribute?.("data-poki-ad-container-id") && (t = e.target,
                                ("none" === t?.style.display || parseInt(t.style.opacity, 10) < 1 || "hidden" === t.style.visibility) && this.destroyAd(e.target))
                    }
                    )
                }
                postSDKMessage = async (t, n = {}) => {
                    V.sendMessage(e.message.sendCommand, {
                        event: t,
                        data: n
                    }, window.top)
                }
                        ...
                        case "hoist_displayAd_onDisplayRendered":
                            {
                                const e = t?.data?.data;
                                if (e) {
                                    const { opportunityId: t, isEmpty: n } = e;
                                    this.#T[t]?.onDisplayRendered?.(n)
                                }
                                break
                            }
                        case "hoist_displayAd_onCanDestroy":
                            {
                                const e = t?.data?.data;
                                if (e) {
                                    const { opportunityId: t } = e;
                                    this.#T[t]?.onCanDestroy?.()
                                }
                                break
                            }
                        case "hoist_videoAd_onStart":
                            {
                                const n = t?.data?.data;
                                if (n) {
                                    const { opportunityId: t } = n;
                                    if (this.#D !== ai)
                                        return;
                                    if (!this.#T[t])
                                        return;
                                    const { onStart: o, position: r } = this.#T[t];
                                    o && o(),
                                        H.dispatchEvent(e.playtest.startVideo, {
                                            position: r
                                        }),
                                        this.#D = "playing"
                                }
                        ...
                        case "hoist_videoAd_onFinish":
                            {
                                const n = t?.data?.data;
                                if (n) {
                                    const { opportunityId: t, rewardAllowed: o } = n;
                                    if (!this.#T[t])
                                        return;
                                    const { onFinish: r, position: i } = this.#T[t];
                                    if (this.#D === ai) {
                                        if (r)
                                            try {
                                    ...
                                    H.dispatchEvent(e.playtest.stopVideo),
                                        this.#D = ii,
                                        delete this.#T[t]
                                }
                                break
            ...
            !function (e) {
                ...
                constructor() {
                    super(new si, !0),
                        window.addEventListener("message", this.__monetization.handleMessageReceived)
                }
            }
            )
        }
